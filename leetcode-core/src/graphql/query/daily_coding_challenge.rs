...
const QUERY_CN: &str = r#"
query questionOfToday {
  todayRecord {
    date userStatus
    question {
      acRate difficulty freqBar frontendQuestionId: questionFrontendId isFavor paidOnly: isPaidOnly
      status title translatedTitle titleSlug hasVideoSolution
